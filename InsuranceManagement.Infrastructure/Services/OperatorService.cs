...
namespace InsuranceManagement.Infrastructure.Services
{
    public class OperatorService : IOperatorService
    {
        ...
        public OperatorService(InsuranceDbContext context, IEmailService emailService)
        {
            _context = context;
        ...
        public async Task<OperatorResponse> AddOperatorAsync(OperatorRequest request)
        {
            ...
            try
            {
                ...
                {
                    var uploadsFolder = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "uploads", "operators");
                    ...
                    logoImageUrl = $"/uploads/operators/{fileName}";
                }
